...
const CORE_RULES = [
  ...
  "When hands are visible, preserve an anatomically coherent hand and stable finger count while describing natural finger articulation plus physically correct contact, grip, occlusion, and release for any handled object. Do not use vague hand motion for a story-critical interaction.",
  "Keep clothing design, fit, colors, and construction unchanged. Describe fabric as following gravity, body motion, contact, inertia, and wind naturally without cloth/body intersection, fabric penetration, floating cloth, rigid cloth, implausible stretching, or independent garment motion.",
