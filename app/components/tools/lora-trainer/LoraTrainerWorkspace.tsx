      ...
      <div className={styles.layout}>
        <main className={styles.main}>
          ...
          {stage === "config" && <section className={styles.panel} aria-labelledby="config-title">
            ...
            <div className={styles.formGrid}>
              <label className={styles.field}><span>模型系列</span><select value={config.family} onChange={(event) => selectFamily(event.target.value as LoraFamily)}><option value="sdxl">SDXL</option><option value="illustrious">WAI Illustrious</option></select></label>
            ...
            <details className={styles.details}><summary>進階設定</summary><div className={styles.advancedGrid}>
               <NumberField label="Rank" value={config.overrides?.rank} min={1} max={256} step={1} onChange={(value) => patchOverride("rank", value)} />
