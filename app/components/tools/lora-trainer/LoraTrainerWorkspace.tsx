      ...
      <div className={styles.layout}>
        <main className={styles.main}>
          ...
          {stage === "config" && <section className={styles.panel} aria-labelledby="config-title">
            ...
            <div className={styles.formGrid}>
              <label className={styles.field}><span>模型系列</span><select value={config.family} onChange={(event) => selectFamily(event.target.value as LoraFamily)}><option value="sdxl">SDXL</option><option value="illustrious">WAI Illustrious</option><option value="z-image">Z-Image</option></select></label>
