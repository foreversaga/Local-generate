...
export default async function JobDetailPage({ params, searchParams }: Props) {
  ...
  return <RoutePage compact eyebrow="page.jobDetail.eyebrow" title="page.jobDetail.title" titleVariables={{ id }} description="page.jobDetail.description"><JobDetailWorkspace jobId={id} sourceHint={source} /></RoutePage>;
}
