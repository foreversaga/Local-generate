...
const EN_SOURCE_LABELS = Object.freeze({ all: "All", video: "Single video", long: "Long video", upscale: "Video upscale", img2img: "Image to Image", lora: "LoRA training", training: "Training data", input: "Input", output: "Generated output" });
...
const EN_DOMAIN_RUNNING_LABELS = Object.freeze({ video: "Generating", long: "Generating", img2img: "Generating", upscale: "Upscaling", lora: "Training" });
